...
internal class AutoNotifyGenerator : GeneratorStep<FieldDeclarationSyntax>
{
	...
	private const string NavigationInterfacesDisplayString = "using WalletWasabi.Fluent.Navigation.Interfaces";
...
#pragma warning restore RS1024
	...
	private string? ProcessClass(INamedTypeSymbol classSymbol, List<IFieldSymbol> fields, ISymbol attributeSymbol, INamedTypeSymbol notifySymbol)
	{
		...
		var classSymbolString = classSymbol.ToDisplayString(format);
		var addInterfacesUsing = classSymbolString.Contains("INavigatable");
		...
		if (addNotifyInterface)
		{
			source.Append(
				...
				#nullable enable
				using ReactiveUI;
				{{(addInterfacesUsing ? $"{NavigationInterfacesDisplayString};" : "")}}

				namespace {{namespaceName}};

				public partial class {{classSymbolString}} : {{notifySymbol.ToDisplayString()}}
				{
				""");
		}
		else
		{
			source.Append(
				...
				public partial class {{classSymbolString}}
				{
				""");
		}
