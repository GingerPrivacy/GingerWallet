...
public static class Constants
{
	...
	public const decimal DefaultMaxCoordinationFeeRate = 0.003m;
	public const decimal DefaultMaxCoinJoinMiningFeeRate = 300.0m;
	public const int DefaultAbsoluteMinInputCount = 6;
	public const int AbsoluteMinInputCount = 6;
	...
	public static readonly Version ClientVersion = new(20250303, 0, 0, 0);

	public static readonly Version HwiVersion = new("3.1.0");
	public static readonly Version BitcoinCoreVersion = new("23.0");
	public static readonly Version GingerLegalDocumentsVersion = new(7, 0);
