...
{
	public OfferModel(ProviderModel provider, decimal amountFrom, string currencyFrom, string countryCode, string? stateCode, BuySellClientModels.PaymentMethodOffer model)
	{
		Provider = provider;
